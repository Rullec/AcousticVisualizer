...
#define ColorBlack tVector4(0, 0, 0, 1)
#define ColorBlue tVector4(0, 196.0 / 255.0, 1, 1)
#define ColorShoJoHi tVector4(220 / 255.0, 38 / 255.0, 35.0 / 255.0, 1) // 猩猩绯
...
#define ColorMetalGray tVector4(0.1f, 0.1f, 0.1f, 1)
#endif