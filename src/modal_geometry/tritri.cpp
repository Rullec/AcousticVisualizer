...
{
    double p1[3];p1[0]=p[0];p1[1]=p[1];p1[2]=p[2];
    double q1[3];q1[0]=p[3];q1[1]=p[4];q1[2]=p[5];
    double r1[3];r1[0]=p[6];r1[1]=p[7];r1[2]=p[8];
    double p2[3];p2[0]=p[9];p2[1]=p[10];p2[2]=p[11];
    double q2[3];q2[0]=p[12];q2[1]=p[13];q2[2]=p[14];
    double r2[3];r2[0]=p[15];r2[1]=p[16];r2[2]=p[17];
...
int ccw_tri_tri_intersection_2d(const double p1[2], const double q1[2], 
